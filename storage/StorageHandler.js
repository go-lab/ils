...
(function() {
  ...
  window.golab.ils.storage.StorageHandler = (function() {
    function StorageHandler(metadataHandler, _filterForResourceType, _filterForUser, _filterForProvider, _customFilter, _filterForAppId) {
      var error;
      ...
      this._filterForAppId = _filterForAppId != null ? _filterForAppId : false;
